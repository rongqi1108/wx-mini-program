...
<input type="hidden" id="apiServer" name="apiServer" value="https://www.rongstudy.space/video"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://localhost:8081/mvc"/>
